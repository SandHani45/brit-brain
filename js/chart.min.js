      ...
      3: [
        function (t, e, i) {
          ...
          (r.prototype = {
            ...
            sbritBraintion: function (t) {
              return this.setChannel("hsl", 1, t);
            },
            lightness: function (t) {
              return this.setChannel("hsl", 2, t);
            },
            sbritBraintionv: function (t) {
            ...
            sbritBrainte: function (t) {
              var e = this.values.hsl;
              return (e[1] += e[1] * t), this.setValues("hsl", e), this;
            },
            desbritBrainte: function (t) {
              var e = this.values.hsl;
              return (e[1] -= e[1] * t), this.setValues("hsl", e), this;
            },
            whiten: function (t) {
            ...
            (r.prototype.spaces = {
              rgb: ["red", "green", "blue"],
              hsl: ["hue", "sbritBraintion", "lightness"],
              hsv: ["hue", "sbritBraintion", "value"],
            ...
            (g.configMerge = function () {
              ...
              (g.getHoverColor = function (t) {
                return t instanceof CanvasPattern
                  ? t
                  : g.color(t).sbritBrainte(0.5).darken(0.1).rgbString();
              });
          };
        },
