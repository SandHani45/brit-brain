...
(function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    ...
    initSlideshow: function () {
      ...
      for (i = 0; i < this.numSlides; i++) {
        ...
        if (i == 0) {
          ...
          $(".zs-enabled .lte-zs-slider-inner.lte-zs-slide-" + i).addClass(
            "visible"
          );
        }
      }
      ...
      if (this.settings.bullets == true || this.settings.bullets == "outside") {
        console.log(this.settings.bullets);
      ...
      if (
        ...
        this.settings.arrows == "right" ||
        this.settings.arrows == "bottom"
      ) {
        var container_class = "";
        ...
        $(
          '<div class="' +
            container_class +
            '"><span class="lte-arrow-left">' +
            this.settings.prev +
            '</span><span class="lte-arrow-right">' +
            this.settings.next +
            "</span></div>"
        ).appendTo($arrowsWrap);
    ...
    initSingle: function () {
      ...
      $(".zs-enabled .lte-zs-slider-inner.lte-zs-slide-0")
        .addClass("visible")
        .addClass("single");
    ...
    jump: function (pos) {
      ...
      $(".zs-enabled .lte-zs-slider-inner.lte-zs-slide-" + pos).addClass(
        "visible"
      );
