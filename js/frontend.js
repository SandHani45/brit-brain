...
jQuery(window).on("elementor/frontend/init", function () {
  ...
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/lte-services.default",
    initServices
  );
...
function initServices() {
  jQuery(".lte-services-sc.lte-layout-tabs .lte-tab").on(
    "click",
    function (i, el) {
      ...
      el.parent()
        .next()
        .find(".lte-item.active")
        .removeClass("active")
        .fadeOut(200, function () {
          setTimeout(function () {
            el.parent()
              .next()
              .find(".lte-item-" + lte_id)
              .addClass("active")
              .fadeIn(400, function () {
...
function initSwiperSliders() {
  ...
  jQuery(lteSliders).each(function (i, el) {
    ...
    if (container.data("arrows")) {
      ...
      if (
        container.data("arrows") == "right-top" ||
