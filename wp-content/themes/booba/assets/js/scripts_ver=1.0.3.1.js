...
function initStyles() {
	...
	jQuery('select.wpcf7-select, aside select, .lte-wc-order select, .variations select').wrap('<div class="select-wrap"></div>')
	...
	jQuery('.woocommerce .checkout-button').removeClass('btn-black color-hover-white').addClass('btn btn-main color-hover-black');
